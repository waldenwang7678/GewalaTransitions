...
import com.example.administrator.asdasdasd.bean.Movie;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.img_movie_photo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // view在整个屏幕的坐标，包括状态栏高度。注意如果view未显示全，获取坐标的bottom是错误的，
                // 最大是屏幕的高度，其实view的bottom要高于屏幕的高度。
                v.getGlobalVisibleRect(rect);

                Movie movie = (Movie) v.getTag(R.id.img_tag);
                Message msg = handler.obtainMessage();  //return new Message()->.target=handler;
